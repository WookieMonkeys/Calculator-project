package com.example.calculator_walter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button one, two, three, four, five, six, seven, eight, nine, zero, clear, clear_everything, add, subtract, multiply, divide, sign, decimal, equals;
